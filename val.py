...
if __name__ == '__main__':
    model_path = '/home/xie/xcl/paper/code/yolov5/runs/train/exp18/weights/best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data='/home/xie/xxs/yolo11（小目标）/ultralytics/cfg/datasets/DUO.yaml',
