...
parser.add_argument('--image_path', default='/home/xie/xxs/dataset/DUO/images/val', type=str, help="path of images")
parser.add_argument('--label_path', default='/home/xie/xxs/dataset/DUO/labels/val', type=str, help="path of labels .txt")
parser.add_argument('--save_path', default='/home/xie/xxs/dataset/DUO/data.json', type=str,
